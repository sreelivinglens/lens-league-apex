...
_CURRICULUM = [
    ...
    },
    {
        ...
        'assignments': {
            'Wildlife':     'Photograph in backlight to catch a rim of light on fur or feathers, then in side light to reveal texture and the catchlight in the eye. Choose for the mood, not by default.',
            ...
            'People':       'Photograph the same person in backlight and side light. Backlight makes a portrait soft and atmospheric; side light reveals texture and character. Pick the one that\'s honest about who they are.',
            ...
            'Drone':        'Fly the same location side-lit by low sun, then directly into it for backlight. Side light reveals texture in land; backlight flattens it into shape.',
            'Wedding':      'Shoot one frame of the couple in hard backlight and one in soft side light. Compare which one protects the emotion of the moment.',
            'Fashion':      'Use only backlight or only side light for the entire shoot — no fill, no reflector. Commit to what the direction does to the garment.',
        },
