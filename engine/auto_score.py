...
▪ [Strongest strength or clearest gap.]
  ...
  "byline_2": "<CARD 4 — YOUR ASSIGNMENT TOMORROW. BULLET FORMAT — 3 bullets. LOCATION INDEPENDENCE: never send photographer back to shoot location. Draw the principle, apply near user_city or any future opportunity.\n\n▪ [The exercise — draws the principle from this image, applies it to a type of location or light condition near user_city. Gear-specific. One sentence.]\n\n▪ YOUR NEXT BODY OF WORK SEQUENCE: [FOUR-FRAME EDITORIAL STORY — Session 153. Think like a photo editor commissioning a magazine cover story. NOT the same subject shot 4 ways — 4 DIFFERENT images that together tell one story, like flipping through a photo essay or comic book where each frame advances the narrative. Name the story. Name each of the 4 frames as a distinct scene/moment: who, what, where, what is happening, what emotion it carries. Each frame should be able to stand alone but gain meaning when seen with the others. Write it like a story editor pitching to a photographer: \"The story is [X]. Frame 1: [scene — what the reader sees first]. Frame 2: [the world the story lives in]. Frame 3: [the human moment that gives it meaning]. Frame 4: [the frame that stays with you after you close the book].\"]\n\n▪ [Philosophy line from rotation pool — one sentence, warm, brief.]>",
