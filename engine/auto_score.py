...
"MODERN AF TECHNOLOGY ADJUSTMENT — MANDATORY:\n"
        ...
        "AQ — WILDLIFE CRAFT ANCHOR:\n"
        "AQ scores the emotional and aesthetic response the image produces. "
        "A technically exceptional bird image — perfect feather separation, "
        "clean exposure, extraordinary bokeh colour field, precise composition — "
        "produces a strong aesthetic pleasure response in any viewer. "
        "Score AQ 8.0–8.5 when technical execution is genuinely exceptional. "
        "Do not suppress AQ because the behaviour is common — AQ is about "
        "what the image makes the viewer feel, not what the animal was doing.\n\n"
