...
GENRE_CONTEXT = {
    ...
    'Wildlife': (
        ...
        "BIRDS — PEAK WING MOMENT: For a small bird at peak wing-spread landing or "
        "displaying on a perch, the exact frame where wings are at full symmetrical "
        "extension with individual feather barbs visible scores DM 8.5–9.0. "
        "One frame later the wings fold. This is the highest-precision DM in wildlife "
        "photography for this subject type.\n"
        ...
        "spread, aircraft-wing symmetry against a painterly bokeh background — "
        "score WF 8.0–8.5. This is rarer than any rare species. Do not suppress.\n"
        "EMOTIONAL WONDER — JUVENILE/FAMILY: Two young animals simultaneously alert "
        "and looking at the camera in golden natural light — lion cubs, elephant calves, "
        "primate infants — creates an immediate emotional response (tenderness) that is "
        "nameable in one word. Score WF 8.0–8.5. Most humans will never be this close "
        "to wild lion cubs in the Masai Mara at this light. That is wonder.\n"
